...
public class CudaMatrixAdapter implements MatrixAdapter {
	...
	public CudaMatrixAdapter mul(double scalingFactor) {
		return new CudaMatrixAdapter(matrix.mul(scalingFactor));
	}
	...
	public MatrixAdapter getRows(
		...
		return new CudaMatrixAdapter(matrix.getRows(inputHiddenGradientRowsForRecurrentHiddenUnits));
	}

	
	public MatrixAdapter addi(MatrixAdapter pairwiseVectorProduct) {
		// TODO Auto-generated method stub
		return new CudaMatrixAdapter(matrix.addi(createCudaDoubleMatrix(pairwiseVectorProduct)));
	...
	public MatrixAdapter expi() {
		return new CudaMatrixAdapter(CudaMatrixFunctions.expi(this.matrix));
	}


	@Override
	public MatrixAdapter powi(int d) {
		return new CudaMatrixAdapter(CudaMatrixFunctions.powi(this.matrix,d));
	}
